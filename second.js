...
const sectionData = {
  ...
  smm: {
    ...
    second_left: "ЛУЧШЕ 1000 ПОДПИСЧИКОВ, КОТОРЫЕ ХОТЯТ КУПИТЬ, ЧЕМ 1000000, КОТОРЫЙ СПОСОБЕН ТОЛЬКО СМОТРЕТЬ.",
    second_up:
      "ЗАДАЧА SMM - продавать, а не просто показывать. Мы создаем мультиканальные воронки, интегрируем в них аккаунты в соц сетях и на видео-хостингах. Наша цель - привлечение только целевой аудитории. Стратегия эффективна как для работы  масс-маркетом, так и для продуктов с высоким средним чеком.",
    second_down: "",
    third_text:
